...
func InitWebServer() *App {
	...
	jwtBlacklistService := service.NewJWTBlacklistService(redisClient)
	authHandler := web.NewAuthHandler(jwtService, jwtBlacklistService)
	handlerFunc := ioc.InitJWTMiddleware(redisClient)
	engine := ioc.InitGin(v, patientHandler, fileHandler, userHandler, healthManagerHandler, roomHandler, bedHandler, careLevelHandler, dietPlanHandler, customerHandler, recordHandler, serviceHandler, careRecordHandler, webSocketManager, analysisHandler, statsHandler, alertHandler, notificationHandler, compatHandler, authHandler, handlerFunc)
